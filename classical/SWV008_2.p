...
tff(formula_8_unnamed_formula, axiom, ![X_g: general, Z1_g: general, Z2_g: general]: ((color(X_g, Z1_g) & color(X_g, Z2_g)) => Z1_g = Z2_g)).
tff(formula_9_unnamed_formula, conjecture, ~(?[X_g: general, Y_g: general, Z_g: general]: ((edge(X_g, Y_g) & color(X_g, Z_g)) & color(Y_g, Z_g)))).
