...
tff(formula_6_constraint_0, conjecture, ![I_g: general, J_g: general, X_g: general]: (((((?[Z_g: general, Z1_g: general]: ((Z_g = I_g & Z1_g = J_g) & p__less__(Z_g, Z1_g)) & ?[Z_g: general]: (Z_g = I_g & in_cover(Z_g))) & ?[Z_g: general]: (Z_g = J_g & in_cover(Z_g))) & ?[Z_g: general, Z1_g: general]: ((Z_g = X_g & Z1_g = I_g) & s(Z_g, Z1_g))) & ?[Z_g: general, Z1_g: general]: ((Z_g = X_g & Z1_g = J_g) & s(Z_g, Z1_g))) => $false)).
