...
tff(formula_7_unnamed_formula, axiom, ![X_g: general]: (?[Y_g: general]: (s(X_g, Y_g)) => ?[Y_g: general]: (s(X_g, Y_g) & in_cover(Y_g)))).
tff(formula_8_unnamed_formula, conjecture, ![Y_g: general, Z_g: general]: (((?[X_g: general]: (s(X_g, Y_g) & s(X_g, Z_g)) & in_cover(Y_g)) & in_cover(Z_g)) => Y_g = Z_g)).
