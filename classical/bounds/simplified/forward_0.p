...
tff(left_0, axiom, ![X: general]: (p__greater__(X, f__integer__(3)) & p__less__(X, f__integer__(5)) => hp(X) & (p__greater__(X, f__integer__(3)) & p__less__(X, f__integer__(5)) => tp(X)))).
tff(right_0, conjecture, ![V1: general]: (V1 = f__integer__(4) => hp(V1) & (V1 = f__integer__(4) => tp(V1)))).
