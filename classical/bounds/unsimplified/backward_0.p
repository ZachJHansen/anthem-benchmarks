...
tff(right_0, axiom, ![V1: general]: (V1 = f__integer__(4) & $true => hp(V1) & (V1 = f__integer__(4) & $true => tp(V1)))).
tff(left_0, conjecture, ![V1: general, X: general]: (V1 = X & (?[Z: general, Z1: general]: (Z = X & Z1 = f__integer__(3) & p__greater__(Z, Z1)) & ?[Z: general, Z1: general]: (Z = X & Z1 = f__integer__(5) & p__less__(Z, Z1))) => hp(V1) & (V1 = X & (?[Z: general, Z1: general]: (Z = X & Z1 = f__integer__(3) & p__greater__(Z, Z1)) & ?[Z: general, Z1: general]: (Z = X & Z1 = f__integer__(5) & p__less__(Z, Z1))) => tp(V1)))).
