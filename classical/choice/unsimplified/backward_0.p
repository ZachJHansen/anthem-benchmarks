...
tff(right_0, axiom, ![V1: general, X: general]: (V1 = X & (?[Z: general]: (Z = X & hp(Z)) & ?[Z: general]: (Z = X & ~~tq(Z))) => hq(V1) & (V1 = X & (?[Z: general]: (Z = X & tp(Z)) & ?[Z: general]: (Z = X & ~~tq(Z))) => tq(V1)))).
tff(left_0, conjecture, ![V1: general, X: general]: (V1 = X & ?[Z: general]: (Z = X & hp(Z)) & ~~tq(V1) => hq(V1) & (V1 = X & ?[Z: general]: (Z = X & tp(Z)) & ~~tq(V1) => tq(V1)))).
