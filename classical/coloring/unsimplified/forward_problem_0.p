...
tff(constraint_0, conjecture, ![X: general, Z1: general, Z2: general]: (?[Z: general, Z2: general]: (Z = X & Z2 = Z1 & color(Z, Z2)) & ?[Z: general, Z1: general]: (Z = X & Z1 = Z2 & color(Z, Z1)) & ?[Z: general, Z3: general]: (Z = Z1 & Z3 = Z2 & Z != Z3) => $false)).
