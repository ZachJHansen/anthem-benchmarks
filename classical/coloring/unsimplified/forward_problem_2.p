...
tff(constraint_2, conjecture, ![X: general, Y: general, Z: general]: (?[Z: general, Z1: general]: (Z = X & Z1 = Y & edge(Z, Z1)) & ?[Z1: general, Z2: general]: (Z1 = X & Z2 = Z & color(Z1, Z2)) & ?[Z1: general, Z2: general]: (Z1 = Y & Z2 = Z & color(Z1, Z2)) => $false)).
