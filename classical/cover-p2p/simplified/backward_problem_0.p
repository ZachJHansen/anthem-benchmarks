...
tff(constraint_0, axiom, ![I: general, J: general, X: general]: (p__less__(I, J) & in_cover(I) & in_cover(J) & s(X, I) & s(X, J) => $false)).
tff(constraint_1, axiom, ![X: general, I: general]: (s(X, I) & ~covered_p(X) => $false)).
...
tff(constraint_0, conjecture, ![I: general, J: general, X: general]: (I != J & in_cover(I) & in_cover(J) & s(X, I) & s(X, J) => $false)).
