...
tff(constraint_0, axiom, ![I: general, J: general, X: general]: (?[Z: general, Z1: general]: (Z = I & Z1 = J & p__less__(Z, Z1)) & ?[Z: general]: (Z = I & in_cover(Z)) & ?[Z: general]: (Z = J & in_cover(Z)) & ?[Z: general, Z1: general]: (Z = X & Z1 = I & s(Z, Z1)) & ?[Z: general, Z1: general]: (Z = X & Z1 = J & s(Z, Z1)) => $false)).
tff(constraint_1, axiom, ![X: general, I: general]: (?[Z: general, Z1: general]: (Z = X & Z1 = I & s(Z, Z1)) & ?[Z: general]: (Z = X & ~covered_p(Z)) => $false)).
...
tff(completed_definition_of_in_cover_1, conjecture, ![V1: general]: (in_cover(V1) <=> (?[I$i: $int, J$i: $int, K$i: $int]: (I$i = 1 & J$i = n$i & V1 = f__integer__(K$i) & $lesseq(I$i, K$i) & $lesseq(K$i, J$i)) & $true & ~~in_cover(V1)))).
