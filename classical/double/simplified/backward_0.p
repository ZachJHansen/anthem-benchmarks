...
tff(right_0, axiom, ![J1$i: $int]: (hp(f__integer__(J1$i)) => hq(f__integer__($product(2, J1$i))) & (tp(f__integer__(J1$i)) => tq(f__integer__($product(2, J1$i)))))).
tff(left_0, conjecture, ![J1$i: $int]: (hp(f__integer__(J1$i)) => hq(f__integer__($sum(J1$i, J1$i))) & (tp(f__integer__(J1$i)) => tq(f__integer__($sum(J1$i, J1$i)))))).
