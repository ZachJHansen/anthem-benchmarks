...
tff(transition_axiom_0, axiom, ![X1: general]: (hq(X1) => tq(X1))).
tff(transition_axiom_1, axiom, ![X1: general]: (hp(X1) => tp(X1))).
tff(right_0, axiom, ![V1: general, X: general]: (?[I$i: $int, J$i: $int]: (V1 = f__integer__($product(I$i, J$i)) & I$i = 2 & f__integer__(J$i) = X) & ?[Z: general]: (Z = X & hp(Z)) => hq(V1) & (?[I$i: $int, J$i: $int]: (V1 = f__integer__($product(I$i, J$i)) & I$i = 2 & f__integer__(J$i) = X) & ?[Z: general]: (Z = X & tp(Z)) => tq(V1)))).
tff(left_0, conjecture, ![V1: general, X: general, Y: general]: (?[I$i: $int, J$i: $int]: (V1 = f__integer__($sum(I$i, J$i)) & f__integer__(I$i) = X & f__integer__(J$i) = Y) & (?[Z: general]: (Z = X & hp(Z)) & ?[Z: general, Z1: general]: (Z = X & Z1 = Y & Z = Z1)) => hq(V1) & (?[I$i: $int, J$i: $int]: (V1 = f__integer__($sum(I$i, J$i)) & f__integer__(I$i) = X & f__integer__(J$i) = Y) & (?[Z: general]: (Z = X & tp(Z)) & ?[Z: general, Z1: general]: (Z = X & Z1 = Y & Z = Z1)) => tq(V1)))).
