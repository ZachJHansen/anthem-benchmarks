...
tff(completed_definition_of_q_1, conjecture, ![V1: general]: (q(V1) <=> ?[X: general]: (V1 = X & (?[Z: general]: (Z = X & p(Z)) & ?[Z: general]: (?[I$i: $int, J$i: $int]: (Z = f__integer__($sum(I$i, J$i)) & f__integer__(I$i) = X & J$i = 1) & ~p(Z)))))).
