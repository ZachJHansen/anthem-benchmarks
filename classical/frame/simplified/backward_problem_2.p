...
tff(constraint_1, axiom, ![P: general, K2$i: $int]: (~in_building_p(P, f__integer__(K2$i)) & person(P) & $lesseq(0, K2$i) & $lesseq(K2$i, h$i) => $false)).
tff(completed_definition_of_in_3, axiom, ![V1: general, V2: general, V3: general]: (in(V1, V2, V3) <=> ?[I$i: $int, K1$i: $int, R: general, T: general]: (V2 = R & V3 = f__integer__(0) & in0(V1, R) | (V3 = f__integer__($sum(I$i, 1)) & f__integer__(I$i) = T & goto(V1, V2, T)) | (V3 = f__integer__($sum(K1$i, 1)) & in(V1, V2, f__integer__(K1$i)) & $lesseq(0, K1$i) & $lesseq(K1$i, $difference(h$i, 1)) & ~~in(V1, V2, V3))))).
tff(completed_definition_of_in_3, conjecture, ![V1: general, V2: general, V3: general]: (in(V1, V2, V3) <=> ?[I$i: $int, K1$i: $int, R: general, T: general]: (V2 = R & V3 = f__integer__(0) & in0(V1, R) | (V3 = f__integer__($sum(I$i, 1)) & f__integer__(I$i) = T & goto(V1, V2, T)) | (V3 = f__integer__($sum(K1$i, 1)) & in(V1, V2, f__integer__(K1$i)) & ~go(V1, f__integer__(K1$i)) & $lesseq(0, K1$i) & $lesseq(K1$i, $difference(h$i, 1)))))).
