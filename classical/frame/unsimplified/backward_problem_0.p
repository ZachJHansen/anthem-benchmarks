...
tff(constraint_0, conjecture, ![P: general, R1: general, T: general, R2: general]: (?[Z: general, Z1: general, Z2: general]: (Z = P & Z1 = R1 & Z2 = T & in(Z, Z1, Z2)) & ?[Z: general, Z1: general, Z2: general]: (Z = P & Z1 = R2 & Z2 = T & in(Z, Z1, Z2)) & ?[Z: general, Z1: general]: (Z = R1 & Z1 = R2 & Z != Z1) => $false)).
