...
tff(constraint_1, axiom, ![P: general, T: general]: (?[Z: general, Z1: general]: (Z = P & Z1 = T & ~in_building_p(Z, Z1)) & ?[Z: general]: (Z = P & person(Z)) & ?[Z: general, Z1: general]: (Z = T & ?[I$i: $int, J$i: $int, K$i: $int]: (I$i = 0 & J$i = h$i & Z1 = f__integer__(K$i) & $lesseq(I$i, K$i) & $lesseq(K$i, J$i)) & Z = Z1) => $false)).
tff(completed_definition_of_in_3, axiom, ![V1: general, V2: general, V3: general]: (in(V1, V2, V3) <=> (?[P: general, R: general]: (V1 = P & V2 = R & V3 = f__integer__(0) & ?[Z: general, Z1: general]: (Z = P & Z1 = R & in0(Z, Z1))) | ?[P: general, R: general, T: general]: (V1 = P & V2 = R & ?[I$i: $int, J$i: $int]: (V3 = f__integer__($sum(I$i, J$i)) & f__integer__(I$i) = T & J$i = 1) & ?[Z: general, Z1: general, Z2: general]: (Z = P & Z1 = R & Z2 = T & goto(Z, Z1, Z2))) | ?[P: general, R: general, T: general]: (V1 = P & V2 = R & ?[I$i: $int, J$i: $int]: (V3 = f__integer__($sum(I$i, J$i)) & f__integer__(I$i) = T & J$i = 1) & (?[Z: general, Z1: general, Z2: general]: (Z = P & Z1 = R & Z2 = T & in(Z, Z1, Z2)) & ?[Z: general, Z1: general]: (Z = T & ?[I$i: $int, J$i: $int, K$i: $int]: (I$i = 0 & ?[I$i: $int, J1$i: $int]: (J$i = $difference(I$i, J1$i) & I$i = h$i & J1$i = 1) & Z1 = f__integer__(K$i) & $lesseq(I$i, K$i) & $lesseq(K$i, J$i)) & Z = Z1)) & ~~in(V1, V2, V3))))).
tff(constraint_1, conjecture, ![P: general, T: general]: (?[Z: general, Z1: general]: (Z = P & Z1 = T & ~in_building(Z, Z1)) & ?[Z: general]: (Z = P & person(Z)) & ?[Z: general, Z1: general]: (Z = T & ?[I$i: $int, J$i: $int, K$i: $int]: (I$i = 0 & J$i = h$i & Z1 = f__integer__(K$i) & $lesseq(I$i, K$i) & $lesseq(K$i, J$i)) & Z = Z1) => $false)).
