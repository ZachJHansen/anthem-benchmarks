...
tff(transition_axiom_0, axiom, hq => tq).
tff(transition_axiom_1, axiom, hp => tp).
tff(left_0, axiom, hp => hq & (tp => tq)).
tff(left_1, axiom, hp & ~tq => $false & (tp & ~tq => $false)).
tff(right_0, conjecture, hp => hq & (tp => tq)).
