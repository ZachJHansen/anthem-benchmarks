...
tff(completed_definition_of_more_than_three_1, axiom, ![V1: general]: (more_than_three(V1) <=> ?[K$i: $int]: ($lesseq(1, K$i) & $lesseq(K$i, n$i) & V1 = f__integer__(K$i) & ~three(V1)))).
tff(completed_definition_of_more_than_three_1, conjecture, ![V1: general]: (more_than_three(V1) <=> ?[K$i: $int]: ($lesseq(1, K$i) & $lesseq(K$i, n$i) & V1 = f__integer__(K$i) & ~three_p(V1)))).
