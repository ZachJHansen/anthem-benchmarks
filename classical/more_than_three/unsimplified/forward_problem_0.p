...
tff(completed_definition_of_more_than_three_1, axiom, ![V1: general]: (more_than_three(V1) <=> ?[N: general]: (V1 = N & (?[Z: general, Z1: general]: (Z = N & ?[I$i: $int, J$i: $int, K$i: $int]: (I$i = 1 & J$i = n$i & Z1 = f__integer__(K$i) & $lesseq(I$i, K$i) & $lesseq(K$i, J$i)) & Z = Z1) & ?[Z: general]: (Z = N & ~three(Z)))))).
tff(completed_definition_of_more_than_three_1, conjecture, ![V1: general]: (more_than_three(V1) <=> ?[N: general]: (V1 = N & (?[Z: general, Z1: general]: (Z = N & ?[I$i: $int, J$i: $int, K$i: $int]: (I$i = 1 & J$i = n$i & Z1 = f__integer__(K$i) & $lesseq(I$i, K$i) & $lesseq(K$i, J$i)) & Z = Z1) & ?[Z: general]: (Z = N & ~three_p(Z)))))).
