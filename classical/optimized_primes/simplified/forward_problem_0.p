...
tff(completed_definition_of_prime_1, axiom, ![V1: general]: (prime(V1) <=> ?[K$i: $int]: ($lesseq(a$i, K$i) & $lesseq(K$i, b$i) & V1 = f__integer__(K$i) & ~composite(V1)))).
tff(completed_definition_of_prime_1, conjecture, ![V1: general]: (prime(V1) <=> ?[K$i: $int]: ($lesseq(a$i, K$i) & $lesseq(K$i, b$i) & V1 = f__integer__(K$i) & ~composite_p(V1)))).
