...
tff(completed_definition_of_prime_1, axiom, ![V1: general]: (prime(V1) <=> ?[I: general]: (V1 = I & (?[Z: general, Z1: general]: (Z = I & ?[I$i: $int, J$i: $int, K$i: $int]: (I$i = a$i & J$i = b$i & Z1 = f__integer__(K$i) & $lesseq(I$i, K$i) & $lesseq(K$i, J$i)) & Z = Z1) & ?[Z: general]: (Z = I & ~composite_p(Z)))))).
tff(completed_definition_of_prime_1, conjecture, ![V1: general]: (prime(V1) <=> ?[I: general]: (V1 = I & (?[Z: general, Z1: general]: (Z = I & ?[I$i: $int, J$i: $int, K$i: $int]: (I$i = a$i & J$i = b$i & Z1 = f__integer__(K$i) & $lesseq(I$i, K$i) & $lesseq(K$i, J$i)) & Z = Z1) & ?[Z: general]: (Z = I & ~composite(Z)))))).
