...
tff(completed_definition_of_p_1, axiom, ![V1: general]: (p(V1) <=> ?[K$i: $int]: (V1 = f__integer__($product(K$i, K$i)) & $lesseq($difference(0, n$i), K$i) & $lesseq(K$i, n$i)))).
tff(completed_definition_of_p_1, conjecture, ![V1: general]: (p(V1) <=> ?[K$i: $int]: (V1 = f__integer__($product(K$i, K$i)) & $lesseq(0, K$i) & $lesseq(K$i, n$i)))).
