...
tff(completed_definition_of_p_1, axiom, ![V1: general]: (p(V1) <=> ?[X: general]: (?[I$i: $int, J$i: $int]: (V1 = f__integer__($product(I$i, J$i)) & f__integer__(I$i) = X & f__integer__(J$i) = X) & ?[Z: general, Z1: general]: (Z = X & ?[I$i: $int, J$i: $int, K$i: $int]: (I$i = 0 & J$i = n$i & Z1 = f__integer__(K$i) & $lesseq(I$i, K$i) & $lesseq(K$i, J$i)) & Z = Z1)))).
tff(completed_definition_of_p_1, conjecture, ![V1: general]: (p(V1) <=> ?[X: general]: (?[I$i: $int, J$i: $int]: (V1 = f__integer__($product(I$i, J$i)) & f__integer__(I$i) = X & f__integer__(J$i) = X) & ?[Z: general, Z1: general]: (Z = X & ?[I$i: $int, J$i: $int, K$i: $int]: (?[I1$i: $int, J$i: $int]: (I$i = $difference(I1$i, J$i) & I1$i = 0 & J$i = n$i) & J$i = n$i & Z1 = f__integer__(K$i) & $lesseq(I$i, K$i) & $lesseq(K$i, J$i)) & Z = Z1)))).
