...
tff(left_0, axiom, ![K2$i: $int]: ($lesseq(0, K2$i) & $lesseq(K2$i, 10) => hp(f__integer__($product(K2$i, K2$i))) & ($lesseq(0, K2$i) & $lesseq(K2$i, 10) => tp(f__integer__($product(K2$i, K2$i)))))).
tff(right_0, conjecture, ![K2$i: $int]: ($lesseq($uminus(10), K2$i) & $lesseq(K2$i, 10) => hp(f__integer__($product(K2$i, K2$i))) & ($lesseq($uminus(10), K2$i) & $lesseq(K2$i, 10) => tp(f__integer__($product(K2$i, K2$i)))))).
