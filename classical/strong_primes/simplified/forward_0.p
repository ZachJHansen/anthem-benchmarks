...
tff(right_0, conjecture, ![I2$i: $int, J2$i: $int]: ($greater(I2$i, 2) & $greater(J2$i, 2) & I2$i = $sum(I2$i, 0) & J2$i = $sum(J2$i, 0) => hcomposite(f__integer__($product(I2$i, J2$i))) & ($greater(I2$i, 2) & $greater(J2$i, 2) & I2$i = $sum(I2$i, 0) & J2$i = $sum(J2$i, 0) => tcomposite(f__integer__($product(I2$i, J2$i)))))).
