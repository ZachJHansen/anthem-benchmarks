...
tff(right_1, conjecture, ![I: general]: (?[I1$i: $int]: (I1$i = $sum(I1$i, 0) & f__integer__(I1$i) = I & ~tcomposite(I)) => hprime(I) & (?[I1$i: $int]: (I1$i = $sum(I1$i, 0) & f__integer__(I1$i) = I & ~tcomposite(I)) => tprime(I)))).
