...
tff(left_0, axiom, ![X: general, I1$i: $int]: (hp(X, f__integer__(I1$i)) => hq(X, f__integer__($sum(I1$i, 1))) & (tp(X, f__integer__(I1$i)) => tq(X, f__integer__($sum(I1$i, 1)))))).
tff(right_0, conjecture, ![X: general, I1$i: $int]: (hp(X, f__integer__($difference(I1$i, 1))) => hq(X, f__integer__(I1$i)) & (tp(X, f__integer__($difference(I1$i, 1))) => tq(X, f__integer__(I1$i))))).
