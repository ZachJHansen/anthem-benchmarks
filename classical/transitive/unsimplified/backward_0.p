...
tff(right_0, axiom, ![V1: general, V2: general, X: general, Y: general]: (V1 = X & V2 = Y & (?[Z: general]: (Z = X & hp(Z)) & ?[Z: general]: (Z = Y & hp(Z))) & ~~tq(V1, V2) => hq(V1, V2) & (V1 = X & V2 = Y & (?[Z: general]: (Z = X & tp(Z)) & ?[Z: general]: (Z = Y & tp(Z))) & ~~tq(V1, V2) => tq(V1, V2)))).
tff(right_1, axiom, ![X: general, Y: general, Z: general]: (?[Z: general, Z1: general]: (Z = X & Z1 = Y & hq(Z, Z1)) & ?[Z1: general, Z2: general]: (Z1 = Y & Z2 = Z & hq(Z1, Z2)) & ?[Z1: general, Z2: general]: (Z1 = X & Z2 = Z & ~tq(Z1, Z2)) & ?[Z: general]: (Z = X & hp(Z)) & ?[Z: general]: (Z = Y & hp(Z)) & ?[Z1: general]: (Z1 = Z & hp(Z1)) => $false & (?[Z: general, Z1: general]: (Z = X & Z1 = Y & tq(Z, Z1)) & ?[Z1: general, Z2: general]: (Z1 = Y & Z2 = Z & tq(Z1, Z2)) & ?[Z1: general, Z2: general]: (Z1 = X & Z2 = Z & ~tq(Z1, Z2)) & ?[Z: general]: (Z = X & tp(Z)) & ?[Z: general]: (Z = Y & tp(Z)) & ?[Z1: general]: (Z1 = Z & tp(Z1)) => $false))).
tff(left_0, conjecture, ![V1: general, V2: general, X: general, Y: general]: (V1 = X & V2 = Y & (?[Z: general]: (Z = X & hp(Z)) & ?[Z: general]: (Z = Y & hp(Z))) & ~~tq(V1, V2) => hq(V1, V2) & (V1 = X & V2 = Y & (?[Z: general]: (Z = X & tp(Z)) & ?[Z: general]: (Z = Y & tp(Z))) & ~~tq(V1, V2) => tq(V1, V2)))).
