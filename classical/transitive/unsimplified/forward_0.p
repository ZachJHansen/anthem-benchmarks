...
tff(right_0, conjecture, ![V1: general, V2: general, X: general, Y: general]: (V1 = X & V2 = Y & (?[Z: general]: (Z = X & hp(Z)) & ?[Z: general]: (Z = Y & hp(Z))) & ~~tq(V1, V2) => hq(V1, V2) & (V1 = X & V2 = Y & (?[Z: general]: (Z = X & tp(Z)) & ?[Z: general]: (Z = Y & tp(Z))) & ~~tq(V1, V2) => tq(V1, V2)))).
