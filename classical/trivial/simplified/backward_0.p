...
tff(left_0, conjecture, ![X: general]: (p__less__(X, f__integer__(3)) & p__greater__(X, f__integer__(5)) => hp(X) & (p__less__(X, f__integer__(3)) & p__greater__(X, f__integer__(5)) => tp(X)))).
