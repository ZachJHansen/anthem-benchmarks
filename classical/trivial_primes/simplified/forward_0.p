...
tff(right_0, conjecture, ![I2$i: $int, J2$i: $int, J1$i: $int]: ($lesseq(2, I2$i) & $lesseq(I2$i, J1$i) & $lesseq(2, J2$i) & $lesseq(J2$i, J1$i) & $greater(J1$i, 2) & J1$i = $sum(J1$i, 0) => hcomposite(f__integer__($product(I2$i, J2$i))) & ($lesseq(2, I2$i) & $lesseq(I2$i, J1$i) & $lesseq(2, J2$i) & $lesseq(J2$i, J1$i) & $greater(J1$i, 2) & J1$i = $sum(J1$i, 0) => tcomposite(f__integer__($product(I2$i, J2$i)))))).
