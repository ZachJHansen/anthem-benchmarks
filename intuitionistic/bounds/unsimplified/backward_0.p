...
tff(right_0, axiom, ![V1: general]: (V1 = f__integer__(4) & $true => p(V1))).
tff(left_0, conjecture, ![V1: general, X: general]: (V1 = X & (?[Z: general, Z1: general]: (Z = X & Z1 = f__integer__(3) & p__greater__(Z, Z1)) & ?[Z: general, Z1: general]: (Z = X & Z1 = f__integer__(5) & p__less__(Z, Z1))) => p(V1))).
