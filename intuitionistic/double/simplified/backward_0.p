...
tff(right_0, axiom, ![J1$i: $int]: (p(f__integer__(J1$i)) => q(f__integer__($product(2, J1$i))))).
tff(left_0, conjecture, ![J1$i: $int]: (p(f__integer__(J1$i)) => q(f__integer__($sum(J1$i, J1$i))))).
