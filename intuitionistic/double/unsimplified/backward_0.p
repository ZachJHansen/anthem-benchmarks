...
tff(right_0, axiom, ![V1: general, X: general]: (?[I$i: $int, J$i: $int]: (V1 = f__integer__($product(I$i, J$i)) & I$i = 2 & f__integer__(J$i) = X) & ?[Z: general]: (Z = X & p(Z)) => q(V1))).
tff(left_0, conjecture, ![V1: general, X: general, Y: general]: (?[I$i: $int, J$i: $int]: (V1 = f__integer__($sum(I$i, J$i)) & f__integer__(I$i) = X & f__integer__(J$i) = Y) & (?[Z: general]: (Z = X & p(Z)) & ?[Z: general, Z1: general]: (Z = X & Z1 = Y & Z = Z1)) => q(V1))).
