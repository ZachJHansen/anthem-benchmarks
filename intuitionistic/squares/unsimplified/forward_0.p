...
tff(left_0, axiom, ![V1: general, X: general, Y: general]: (V1 = Y & (?[Z: general, Z1: general]: (Z = X & ?[I$i: $int, J$i: $int, K$i: $int]: (I$i = 0 & J$i = 10 & Z1 = f__integer__(K$i) & $lesseq(I$i, K$i) & $lesseq(K$i, J$i)) & Z = Z1) & ?[Z: general, Z1: general]: (Z = Y & ?[I$i: $int, J$i: $int]: (Z1 = f__integer__($product(I$i, J$i)) & f__integer__(I$i) = X & f__integer__(J$i) = X) & Z = Z1)) => p(V1))).
tff(right_0, conjecture, ![V1: general, X: general, Y: general]: (V1 = Y & (?[Z: general, Z1: general]: (Z = X & ?[I$i: $int, J$i: $int, K$i: $int]: (I$i = $uminus(10) & J$i = 10 & Z1 = f__integer__(K$i) & $lesseq(I$i, K$i) & $lesseq(K$i, J$i)) & Z = Z1) & ?[Z: general, Z1: general]: (Z = Y & ?[I$i: $int, J$i: $int]: (Z1 = f__integer__($product(I$i, J$i)) & f__integer__(I$i) = X & f__integer__(J$i) = X) & Z = Z1)) => p(V1))).
