...
tff(left_1, conjecture, ![I: general, V1: general]: (V1 = I & (?[Z: general, Z1: general]: (?[I1$i: $int, J$i: $int]: (Z = f__integer__($sum(I1$i, J$i)) & f__integer__(I1$i) = I & J$i = 0) & Z1 = I & Z = Z1) & ?[Z: general]: (Z = I & ~composite(Z))) => prime(V1))).
