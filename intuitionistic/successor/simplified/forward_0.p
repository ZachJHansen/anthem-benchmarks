...
tff(left_0, axiom, ![X: general, I1$i: $int]: (p(X, f__integer__(I1$i)) => q(X, f__integer__($sum(I1$i, 1))))).
tff(right_0, conjecture, ![X: general, I1$i: $int]: (p(X, f__integer__($difference(I1$i, 1))) => q(X, f__integer__(I1$i)))).
