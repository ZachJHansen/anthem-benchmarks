...
tff(left_0, axiom, ![V1: general, V2: general, X: general, Y: general]: (V1 = X & ?[I$i: $int, J$i: $int]: (V2 = f__integer__($sum(I$i, J$i)) & f__integer__(I$i) = Y & J$i = 1) & ?[Z: general, Z1: general]: (Z = X & Z1 = Y & p(Z, Z1)) => q(V1, V2))).
tff(right_0, conjecture, ![V1: general, V2: general, X: general, Y: general]: (V1 = X & V2 = Y & ?[Z: general, Z1: general]: (Z = X & ?[I$i: $int, J$i: $int]: (Z1 = f__integer__($difference(I$i, J$i)) & f__integer__(I$i) = Y & J$i = 1) & p(Z, Z1)) => q(V1, V2))).
