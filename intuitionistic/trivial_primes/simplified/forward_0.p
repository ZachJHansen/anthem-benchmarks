...
tff(left_0, axiom, ![I2$i: $int, J2$i: $int, J1$i: $int]: ($lesseq(2, I2$i) & $lesseq(I2$i, J1$i) & $lesseq(2, J2$i) & $lesseq(J2$i, J1$i) & $greater(J1$i, 2) & J1$i = $sum(J1$i, 0) => composite(f__integer__($product(I2$i, J2$i))))).
tff(left_1, axiom, ![I: general]: (?[I1$i: $int]: (I1$i = $sum(I1$i, 0) & f__integer__(I1$i) = I & ~composite(I)) => prime(I))).
tff(right_0, conjecture, ![I2$i: $int, J2$i: $int, J1$i: $int]: ($lesseq(2, I2$i) & $lesseq(I2$i, J1$i) & $lesseq(2, J2$i) & $lesseq(J2$i, J1$i) & $greater(J1$i, 2) & J1$i = $sum(J1$i, 0) => composite(f__integer__($product(I2$i, J2$i))))).
