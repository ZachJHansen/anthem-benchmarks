...
tff(right_0, axiom, ![I: general, J: general, N: general, V1: general]: (?[I1$i: $int, J1$i: $int]: (V1 = f__integer__($product(I1$i, J1$i)) & f__integer__(I1$i) = I & f__integer__(J1$i) = J) & (?[Z: general, Z1: general]: (Z = I & ?[I$i: $int, J$i: $int, K$i: $int]: (I$i = 2 & f__integer__(J$i) = N & Z1 = f__integer__(K$i) & $lesseq(I$i, K$i) & $lesseq(K$i, J$i)) & Z = Z1) & ?[Z: general, Z1: general]: (Z = J & ?[I$i: $int, J$i: $int, K$i: $int]: (I$i = 2 & f__integer__(J$i) = N & Z1 = f__integer__(K$i) & $lesseq(I$i, K$i) & $lesseq(K$i, J$i)) & Z = Z1) & ?[Z: general, Z1: general]: (Z = N & Z1 = f__integer__(2) & p__greater__(Z, Z1)) & ?[Z: general, Z1: general]: (?[I$i: $int, J$i: $int]: (Z = f__integer__($sum(I$i, J$i)) & f__integer__(I$i) = N & J$i = 0) & Z1 = N & Z = Z1)) => composite(V1))).
tff(right_1, axiom, ![V1: general]: (V1 = f__integer__(4) & ?[Z: general]: (Z = f__integer__(4) & composite(Z)) => composite(V1))).
tff(right_2, axiom, ![I: general, V1: general]: (V1 = I & (?[Z: general, Z1: general]: (?[I1$i: $int, J$i: $int]: (Z = f__integer__($sum(I1$i, J$i)) & f__integer__(I1$i) = I & J$i = 0) & Z1 = I & Z = Z1) & ?[Z: general]: (Z = I & ~composite(Z))) => prime(V1))).
